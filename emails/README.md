...
```
> curl -XPOST -H "Content-Type: application/json" localhost:9000/com.softwaremill.test.CounterService/GetCurrentCounter -d '{"counterId": "foo"}'
...
```shell
> grpcurl -plaintext -d '{"counterId": "foo"}' localhost:9000 com.softwaremill.test.CounterService/GetCurrentCounter 
ERROR:
  Code: Unknown
